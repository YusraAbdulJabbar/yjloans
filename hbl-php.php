...
<body>
    ...
    <div id="subheader" style="margin-top:12px;">
        <h6 style="padding-left:20px">Habib Bank Limited</h6>
    </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <?php
                    $link = mysqli_connect("localhost", "root", "", "yjl", 3308);
                    $sql = " SELECT * FROM tenor where tid=4";
                    $result = $link->query($sql);
  ...
  color: white; font-weight: bold"> TIER-3</td>
        ...
        <div>
            ...
            <p>You are eligible for NAPHDA from HBL Bank if:</p>


            <?php
            $link = mysqli_connect("localhost", "root", "", "yjl", 3308);
            $sql = " SELECT * FROM criteria where eid=6";
            $result = $link->query($sql);
