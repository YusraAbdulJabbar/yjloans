  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        $sql = " SELECT * FROM tenor where tstatus = 1";
        ...
        <tr>
          ...
          <td><a href="tenor-update.php?tid=<?php echo $rows['tid']; ?>">Edit</a>
            <a href="tenor-del.php?tid=<?php echo $rows['tid']; ?>">Delete</a>
            <a href="tenor-vieweach.php?tid=<?php echo $rows['tid']; ?>">View</a>
          </td>
