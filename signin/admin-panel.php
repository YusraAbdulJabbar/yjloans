...
;">&nbsp&nbsp&nbspYJLoans&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</h4>
            <div class="app-header__log">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="bankscards/naphda-form.php">
                                            <i class="metismenu-icon"></i>
                                            NAPHDA form
                                        </a>
                                    </li>
                                    <li>
                                        <a href="bankscards/naphda-table.php">
                                            <i class="metismenu-icon"></i>
                                            BANKS table
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="definecards/cards-form.php">
                                            <i class="metismenu-icon">
                                            </i>Loan terms form
                                        </a>
                                    </li>
                                    <li>
                                        <a href="definecards/loanterms-table.php">
                                            <i class="metismenu-icon">
                                            </i>Loan terms table
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="tenor/tenor-form.php">
                                            <i class="metismenu-icon">
                                            </i>Tenor form
                                        </a>
                                    </li>
                                    <li>
                                        <a href="tenor/tenor-table.php">
                                            <i class="metismenu-icon">
                                            </i>Tenor table
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="criteria/criteria-form.php">
                                            <i class="metismenu-icon">
                                            </i>Criteria form
                                        </a>
                                    </li>
                                    <li>
                                        <a href="criteria/criteria-table.php">
                                            <i class="metismenu-icon">
                                            </i>criteria table
                                        </a>
                                    </li>
